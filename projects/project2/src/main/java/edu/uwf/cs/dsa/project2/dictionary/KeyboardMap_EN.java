...
public class KeyboardMap_EN implements KeyboardMap{
	
	private Map<Character, List<Character>> neighbors; 
	
	public KeyboardMap_EN() {
		neighbors = new HashMap<Character, List<Character>>();
		...
		neighbors.put('o', new ArrayList<Character>(Arrays.asList('i','p')));
	...
	@Override
	public List<Character> neighbors(char c) {
